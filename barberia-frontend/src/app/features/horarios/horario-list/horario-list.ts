    ...
    <div class="module-container">
      ...
      <div class="table-card glass">
        <table class="table">
          ...
          <tbody>
            <tr *ngFor="let horario of filteredData()">
              ...
              <td>
                <div class="actions-group">
                  <button class="btn-icon view" (click)="verDetalle(horario)">
...
export class HorarioListComponent implements OnInit {
  ...
  guardar(): void {
    ...
    const dto = {
      idHorario: formValue.idHorario,
      diaSemana: formValue.diaSemana,
      horaInicio: formValue.horaInicio ? formValue.horaInicio : null,
      horaFin: formValue.horaFin ? formValue.horaFin : null,
      idBarbero: formValue.barbero ? formValue.barbero.idBarbero : null
    };

    this.barberiaService.saveHorario(dto).subscribe({
      next: () => {
